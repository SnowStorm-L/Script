...
// fork form https://github.com/appculture/xcode-project-renamer

// 作用
// 修改Xcode项目名称

// 使用方法
// 终端 cd 到 *.xcodeproj 同个目录下, 把此文件放到同个目录下
// chmod xxx ProjectRename.swift 给予执行权限

// ./ProjectRename.swift "旧工程名" "新工程名"
...
class XcodeProjectRenamer: NSObject {
    ...
    private func shouldSkip(_ element: String) -> Bool {
        guard
            ...
            !element.contains("build") else { return true }
